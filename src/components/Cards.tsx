...
const Cards = ({ searchTerm }: { searchTerm: string }) => {
  ...
  return (
    <div className="md:bg-[url('/images/bottombg.png')] md:bg-no-repeat md:bg-left-bottom md:bg-[length:100vw_130vh] bg-[url('/images/bgGreyMobil.png')] bg-[length:100%_60%] bg-no-repeat bg-right">
